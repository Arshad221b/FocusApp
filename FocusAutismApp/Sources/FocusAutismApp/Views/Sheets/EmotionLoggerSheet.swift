...
struct EmotionLoggerSheet: View {
                        ...
                        LazyVGrid(columns: [GridItem(.adaptive(minimum: 65))], spacing: 6) {
                            ForEach(Emotion.allCases, id: \.self) { emotion in
                                Button(action: { primaryEmotion = emotion }) {
                                    ...
                                    .background(primaryEmotion == emotion ? Theme.accent.opacity(0.25) : Theme.card)
                                    .foregroundColor(primaryEmotion == emotion ? Theme.accent : Theme.textMuted)
                                    .cornerRadius(8)
                                    .overlay(
                                        RoundedRectangle(cornerRadius: 8)
                                            .stroke(primaryEmotion == emotion ? Theme.accent : Color.clear, lineWidth: 1.5)
                                    )
                                }
                                .buttonStyle(.plain)
                            }
                            ...
                            ForEach(PhysicalSymptom.allCases, id: \.self) { symptom in
                                Button(action: {
                                    ...
                                    Text(symptom.rawValue)
                                        ...
                                        .padding(.vertical, 6)
                                        .background(physicalSymptoms.contains(symptom) ? Theme.danger.opacity(0.2) : Theme.card)
